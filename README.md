...
- [시스템 구조](#시스템-구조)
- [주요 기능](#주요-기능)
- [기능 화면 미리 보기](#기능-화면-미리보기)
- [트러블 슈팅 & 배운 점](#5-트러블-슈팅)
- [추후 추가 기능](#6-추후-추가-기능)
...
- 통합 검색
- 주변CCTV
- 리뷰 : 로그인 사용자, 다중 이미지 업로드 포함
- 고객문의 : 1:1 문의 게시판판, 관리자 답변, 게시시판
...
- SQL 검색 조건 처리 시 NULL 데이터 이슈를 트러블 슈팅을 통해 해결
...
실시간으로 “ 여기가 안전합니다 “ / “여기를 추천합니다” 라는 채팅이 있으면
	더 좋을것 같다고 생각함
2. 유저 축제/관광지 찜 콘텐츠  알림 서비스( 관광지/축제)
유저들의 축제 / 관광지 등 찜 기능 / 찜 한 콘텐츠(축제) 시작 기간 알림 “ 축제까지 얼마 남았습니다 “ 기능 발송 ( 모바일 확장 )
3. 인기검색어 / 오늘 가장 많이 검색된 검색어
인기 검색어 Top 10 을 모아 상위부터 뿌리게끔 처리 
오늘 가장 많이 검색된 검색어로 유저들에게 실시간 인기 관광지, 축제 뿌림
4. 다국어 지원 서비스
여행은 내국인 뿐만 아니라 외국인이 많기에 다국어 서비스를 지원하면 더 활용성이 좋아질것 같음음
